...
export const DEFAULT_SECTIONS = [
  ...
  },
  {
    ...
    contentRu: {
      ...
      galleryCta: "Смотреть всю галерею",
    ...
    contentLv: {
      ...
      galleryCta: "Skatīt visu galeriju",
      ...
      closing:
        "Mūsu mērķis nav vienkārši veikt elektroinstalācijas darbus, bet radīt nevainojamu rezultātu, ko izmantosiet desmitgadēm. Iedomājam katru detaļu, novēršam kļūdas vēl pirms darbu sākuma un veicam montāžu tā, kā to darītu savā mājā.",
