...
export const DEFAULT_SECTIONS = [
  ...
  },
  {
    ...
    contentRu: {
      ...
      teaser:
        "Качественная электрика начинается с грамотного планирования. Ещё до монтажа вы увидите будущий результат в реальном масштабе — шаблоны 1:1 на стенах.",
      ctaText: "Подробнее о сервисе",
      ctaHref: "/design",
      imageUrl: "/img/design-templates-wall.jpg",
      gallery: [
      ...
      processSteps: ["Проект", "Шаблоны 1:1", "Согласование", "Подтверждение", "Точный монтаж"],
      processNote:
      ...
      detailCta: "Подробнее",
      detailTitle: "Как устроено планирование",
      detailBody: [
        "Качественная электрика начинается с грамотного планирования. Поэтому ещё до начала монтажа мы предлагаем увидеть будущий результат в реальном масштабе.",
        "Мы изготавливаем полноразмерные шаблоны в масштабе 1:1 по проекту. Шаблоны временно устанавливаются на стены, чтобы заказчик мог заранее увидеть расположение розеток, выключателей и других элементов непосредственно в помещении.",
        "Это позволяет проверить удобство, высоты, расстояния и соответствие интерьеру до сверления и штробления стен. При работе по дизайн-проекту мы также можем согласовать расположение электроустановочных изделий с дизайнером.",
        "Процесс простой: проект → шаблоны 1:1 → согласование → подтверждение → точный монтаж. После утверждения расположения шаблоны используются как кондукторы для сверления — согласованная схема переносится на стены без догадок и переделок.",
      ],
    ...
    contentLv: {
      ...
      teaser:
        "Kvalitatīva elektroinstalācija sākas ar pārdomātu plānošanu. Vēl pirms montāžas jūs ieraudzīsiet rezultātu reālā mērogā — veidnes 1:1 uz sienām.",
      ...
      processSteps: ["Projekts", "Veidnes 1:1", "Saskaņošana", "Apstiprinājums", "Precīza montāža"],
      processNote:
      ...
      detailCta: "Lasīt vairāk",
      detailTitle: "Kā notiek plānošana",
      detailBody: [
        "Kvalitatīva elektroinstalācija sākas ar pārdomātu plānošanu. Tāpēc vēl pirms montāžas sākuma piedāvājam ieraudzīt nākamo rezultātu reālā mērogā.",
        "Mēs izgatavojam pilna izmēra veidnes mērogā 1:1 pēc projekta. Veidnes īslaicīgi tiek uzstādītas uz sienām, lai pasūtītājs iepriekš ieraudzītu kontaktligzdu, slēdžu un citu elementu izvietojumu tieši telpā.",
        "Tas ļauj pārbaudīt ērtumu, augstumus, attālumus un atbilstību interjeram pirms urbšanas un sienu štrobešanas. Strādājot pēc dizaina projekta, izvietojumu varam saskaņot arī ar dizaineru.",
        "Process ir vienkāršs: projekts → veidnes 1:1 → saskaņošana → apstiprinājums → precīza montāža. Pēc apstiprināšanas veidnes kļūst par vadotnēm urbšanai — shēma tiek pārnesta uz sienām bez minējumiem un pārtaisījumiem.",
      ],
    ...
    contentEn: {
      ...
      teaser:
        "Quality electrics starts with proper planning. Before installation you see the result at real scale — 1:1 templates on the walls.",
      ...
      processSteps: ["Project", "1:1 templates", "Alignment", "Confirmation", "Precise install"],
      processNote:
      ...
      detailCta: "Read more",
      detailTitle: "How planning works",
      detailBody: [
        "Quality electrics starts with proper planning. That is why, before installation begins, we offer to see the future result at real scale.",
        "We manufacture full-size templates at 1:1 scale from the project. Templates are temporarily mounted on walls so the client can see socket, switch and fitting placement in the room itself.",
        "This lets you check convenience, heights, distances and interior fit before drilling or chasing. On design projects we can also align positions with the designer.",
        "The process is simple: project → 1:1 templates → alignment → confirmation → precise install. After approval, templates become drilling guides — the agreed layout moves to the walls without guesswork or rework.",
      ],
