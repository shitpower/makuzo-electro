...
export async function generateMetadata({ params }) {
  ...
  return {
    ...meta,
    alternates: {
      canonical: withLocale(locale, "/smart-home"),
      languages: {
        ru: "/ru/smart-home",
        lv: "/lv/smart-home",
        en: "/en/smart-home",
...
export default async function SmartHomePage({ params }) {
  const { locale: localeParam } = await params;
  const locale = resolveLocaleParam(localeParam);
      ...
      <AnimatedSection className="border-b border-[var(--line)] bg-[var(--mist)] pb-14 pt-10 md:pb-20 md:pt-14">
        <div className="container-site grid items-center gap-10 lg:grid-cols-[0.9fr_1.2fr] lg:gap-12">
          <div className="flex flex-col gap-6">
            ...
            <Link href={withLocale(locale, "/#contacts")} className="btn-primary mt-2 inline-flex w-fit items-center justify-center gap-2">
              <ButtonLabel arrow>
